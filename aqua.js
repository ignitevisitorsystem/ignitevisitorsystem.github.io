  ...
  var db = firebase.firestore();
    ...
    .then((querySnapshot) => {
	 console.log("Snapshot:" + querySnapshot.size); 
        var cnt = querySnapshot.size;
	document.write(title);
	document.write("<center><h4>Find name and Tap 'Check-In'</b></h4></center><center>If name is not found below, click <a href='" +  "https://ignitemeeting.github.io/?ipad=Yes"   + "'>here</a> to continue!<br><br></center>");
        if (cnt === 0){
		 var nodata = "<br>No data found<br>";
	  document.write(nodata);
	}else{
